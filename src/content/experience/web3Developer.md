...
1. `AI Data Marketplace (Smart contracts + Backend infrastructure)`
...
3. `Memecoin Game Arcade (Smart contracts + Backend infrastructure + Frontend UI)`
